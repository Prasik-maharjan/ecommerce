    ...
    return(
        <div className="">
          <div className="bottom-[75%] sm:bottom-[20%] left-[10%] absolute">
            <h1 className="hidden md:block font-bold">UP TO 40% OFF CHARGERS AND MORE.</h1>
            <p className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl">
              Savings for <br></br> dads and grads.
            </p>           
              <button className="flex gap-4 font-bold items-center py-2 px-4 bg-black text-white rounded-full my-7">
        ...
        <div className="flex gap-x-10 text-xs py-6 font-bold animate-marquee float-right">
